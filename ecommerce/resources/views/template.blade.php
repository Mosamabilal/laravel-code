            ...
            <div class="menu-block">
              <nav id="main-nav">
                ...
                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                  ...
                  <!--HOME-->
                  <li>
                    <a class="dark-menu-item" href="{{URL('/')}}">Home</a> </li>
                  <!--HOME-END-->
                  <!--SHOP-->
                  <li><a class="dark-menu-item" href="{{URL('/shop')}}">shop</a></li>
                  <!--SHOP-END-->
                  <!--SHOP-->
                  <li><a class="dark-menu-item" href="{{URL('/about')}}">About Us</a></li>
                  <!--SHOP-END-->
                  <!--product-meu start-->
                  <li><a  class="dark-menu-item" href="{{URL('/contact')}}">Contact</a></li>
